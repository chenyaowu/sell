                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button onclick="javascript: document.getElementsById('notice').pause()" type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
...
<script>
    ...
    websocket.onmessage = function (even) {
        ...
        //弹窗
        $('#myModal').modal('show');
        document.getElementsById('notice').play();
    }
